...
async function runDts(outputFileName, outputDirName, {remote, local, run$wFixer, documentationTemplate}) {
  ...
  try {
    ...
    const dtsContent = dts(repo.services, {run$wFixer, documentationTemplate})
